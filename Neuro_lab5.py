# -*- coding: utf-8 -*-
"""
Created on Thu Apr 24 17:32:29 2025
...
train_dataset = torchvision.datasets.ImageFolder(root='d:/Download/data/train',
                                                 transform=data_transforms)
test_dataset = torchvision.datasets.ImageFolder(root='d:/Download/data/test',
                                             transform=data_transforms)
...
for epoch in range(num_epochs):
    for i, (images, labels) in enumerate(train_loader):
        ...
        if i%100==0:
            print('Эпоха ' + str(epoch) + ' из ' + str(num_epochs) + ' Ошибка: ', loss.item())
